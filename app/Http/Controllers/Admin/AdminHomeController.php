...
class AdminHomeController extends Controller
{
    public function index()
    {
        ...
        return view('admin.home', compact('total_completed_orders','total_pending_orders','total_active_customers','total_pending_customers','total_products','total_subscribers','orders'));
    }
}
