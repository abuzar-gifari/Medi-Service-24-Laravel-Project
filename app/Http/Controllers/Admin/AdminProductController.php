...
class AdminProductController extends Controller
{
    ...
    public function show(){
        $products = Product::where('vendor_id','=','0')->get();
    ...
    public function store(Request $request){
        ...
        $product->vendor_id = '0';
        $product->save();
        return redirect()->route('admin_product_show')->with('success_message','Product Created Successfully');
    ...
    public function update(Request $request,$id){
        ...
        $product->vendor_id = '0';
        $product->update();
        return redirect()->route('admin_product_show')->with('success_message','Information Updated Successfully');
    ...
    public function delete($id){
        ...
        return redirect()->route('admin_product_show')->with('success_message','Data is Deleted Successfully');
    }
    ...
    public function gallery($id){
        ...
        return view('admin.product_gallery',compact('product','product_photos'));
    }
