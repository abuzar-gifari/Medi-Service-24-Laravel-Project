...
class CustomerAuthController extends Controller
{
    ...
    public function login_submit(Request $request)
    {
        ...
        if(Auth::guard('customer')->attempt($credential)) {
            ...
            return redirect()->route('login-page')->with('error', 'Information is not correct!');
        }
    }
    ...
    public function signup_verify($email,$token)
    {
        ...
        if($customer_data) {
            ...
            return redirect()->route('login-page')->with('success', 'Your account is verified successfully!');
    ...
    public function forget_password_submit(Request $request)
    {
        ...
        return redirect()->route('login-page')->with('success','Please check your email and follow the steps there');
    ...
    public function reset_password_submit(Request $request)
    {
        ...
        return redirect()->route('login-page')->with('success', 'Password is reset successfully');
