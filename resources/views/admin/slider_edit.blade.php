...
@section('button')
<div class="ml-auto">
<a href="{{ route('admin_slider_show') }}" class="btn btn-primary"><i class="fa fa-eye"></i> View All</a>
</div>
@endsection
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="mb-4">
                                    ...
                                    <input type="text" class="form-control" name="name" value="{{ $slider_data->name }}">
                                </div>
                                <div class="mb-4">
