...
<div class="section-body">
    <form action="{{ route('vendor_product_update',$product->id) }}" method="post" enctype="multipart/form-data">
        @csrf
        <div class="row">
            <div class="col-12">
                <div class="card">
...
@section('right_top_button')
    <div class="ml-auto">
        <a href="{{ route('vendor_product_show') }}" class="btn btn-primary"><i class="fas fa-eye"></i> View</a>
    </div>
@endsection
